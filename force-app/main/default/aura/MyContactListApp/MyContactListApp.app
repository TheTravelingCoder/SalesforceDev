...
(function(){
    ...
    var theLabel = cmp.get("v.label");
        ...
        function document.getElementById(test)
        {
        console.log(test);
        }
        alert('fine');
        var foo = document.getElementById('test');
        var foos = document.getElementsByName('test');
         console.log("TEST");
...
!function(factory) {
    ...
    if (typeof require === 'function' || typeof exports === 'object' || typeof module === 'object') {
        ...
        // [3] No module loader (plain tag) - put directly in global namespace
        factory(window['ko'] = {});
    }
}(function(koExports){
...
(function () {
    ...
    ko.utils.setHtml = function(node, html) {
        ...
        if ((html !== null) || (html !== undefined)) {
            ...
            // for example  elements which are not normally allowed to exist on their own.
...
ko.bindingHandlers['options'] = {
    'update': function (element, valueAccessor, allBindingsAccessor) {
        ...
        // Remove all existing s.
        // Need to use .remove() rather than .removeChild() for s otherwise IE behaves oddly (https://github.com/SteveSanderson/knockout/issues/134)
